  ...
  return (
    <section className="h-16 flex justify-between items-center">
      ...
      <div className="flex place-items-center space-x-6">
        ...
        <Link to={"/"}>
          <div className="bg-blue-500 text-white p-2 rounded-full relative">
            {/* cart icon */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <div className="absolute top-0 right-0 text-white flex justify-center bg-black w-4 h-4 rounded-full text-xs">
              {cart.items.length}
            </div>
          </div>
        </Link>
